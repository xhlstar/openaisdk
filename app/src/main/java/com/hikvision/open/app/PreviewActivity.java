...
//    private static final String previewUri = "rtsp://10.40.239.31:554/openUrl/xjmVph6";
    private String previewUri = "rtsp://10.66.165.243:655/EUrl/8ccdhg4";
    ...
    private void initView() {
        ...
        new Thread(new Runnable() {
            @Override
            public void run() {
//                String serverRTSPURL;
                previewUri = getRTSPURL();
//                String reg = "[a-zA-z]+://(25[0-5]|2[0-4]\\d|1\\d{2}|[1-9]?\\d)(\\.(25[0-5]|2[0-4]\\d|1\\d{2}|[1-9]?\\d)){3}";
//                String replace = "rtsp://47.99.135.97";
//                previewUri = serverRTSPURL.replaceAll(reg,replace);
...
//        start.setVisibility(visibility);
    ...
    public String getRTSPURL(){
        ...
        String cameraIndex = ArtemisPost.getCameras();

        String rtspUrl = ArtemisPost.getRTSPURL(cameraIndex);
